...
const film = {
    ...
    renderFilmBlock() {
        let filmName = this.name,
            ...
            filmBh = this.behance,
            filmHTML = `
            <div class="cinema__tab">
            <div class="cinema__movie1">
                    <div class="cinema__relative">
                        <div class="cinema__img">
                            <img src="${filmImage}" alt="фильм" class="cinema__img_resina">
                        </div>
                        <div class="cinema__descr">
                            <div class="cinema__text1">${filmName}</div>
                            <div class="cinema__sep"></div>
                            <div class="cinema__text2">${filmDescription}</div>
                            <div class="cinema__linis">
                                <a href="${filmFb}"><i class="cinema__icon icon_facebook"><img src="img/facebook  .png"
                                            alt="фейсбук"></i></a>
                                <a href="${filmTw}"><i class="cinema__icon icon_twiter"><img src="img/twitter.png"
                                            alt="твитер"></i></a>
                                <a href="${filmBh}"><i class="cinema__icon icon_behance"><img src="img/behance.png"
                                            alt="беханс"></i></a>
                            </div>
                        </div>
                    </div>
